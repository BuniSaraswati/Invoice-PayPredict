...
public class InvoiceManagement {
    ...
    public InvoiceManagement(int sl_no) {
		this.sl_no = sl_no;
	}
    //use getter and setter instead of consturtor
    public InvoiceManagement(String business_code,int cust_number,Date clear_date,int buisness_year,String doc_id,Date posting_date,Date document_create_date,Date document_create_date1,Date due_in_date,String invoice_currency,String document_type,int posting_id,String area_business,Double total_open_amount,Date baseline_create_date,String cust_payment_terms,int invoice_id/**String aging_bucket,int isOpen,int is_deleted**/) {
